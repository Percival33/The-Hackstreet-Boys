...
- własności rzeczy, które znajdują się na terytorium Polski lub praw majątkowych wykonywanych na terytorium Polski, w drodze:
...
DR1_DESCRIPTION = """
Obowiązek podatkowy rolny powstaje z pierwszym dniem miesiąca następującego po miesiącu, w którym podatnik objął grunt: na własność, w samoistne lub zależne posiadanie, lub w wieczyste użytkowanie.
